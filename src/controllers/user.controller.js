...
const registerUser = asyncHandler( async(req,res) => {
    ...
    //get user details from frontend 1️⃣
    //validation-not empty 2️⃣
    //check if user already exists: email,username  3️⃣
    //check for images, check for avatar  4️⃣
    //upload them to cloudinary:avatar  5️⃣
    //create user object-user entry in db  6️⃣
    //remove password and refresh token fields from response  7️⃣
